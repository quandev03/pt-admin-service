...
@Slf4j
@Tag(name = "Third Party Authentication/Authorization API")
@RestController("thirdPartyAuthController")
@RequestMapping("${application.third-party-oAuth2-client-info.api-prefix}/private/api/auth")
