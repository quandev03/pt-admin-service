...
public class DbMapper {
    ...
    @Autowired
    public DbMapper(ApplicationContext applicationContext) {
        this.applicationContext = applicationContext;
        typeConverterMap = new HashMap<>();
        typeConverterMap.put(Character.class, this::getCharSafe);
    ...
    protected FormattingConversionService getConverterRegistry() {
        return this.applicationContext.getBean(FormattingConversionService.class);
    }

    public String getCharSafe(Tuple tuple, String field) {
        Character character = tuple.get(field, Character.class);
        ...
        for (Field field : clazz.getDeclaredFields()) {
            ...
            if (dbColumnMapper != null) {
                ...
                try {
                    ...
                    String label = ObjectUtils.isEmpty(this.getAnnotationValue(dbColumnMapper)) ? StringUtil.camelToSnake(propPascalCase)
    ...
    public <R> List<R> castSqlResult(List<Tuple> tuples, Class<R> clazz) {
        ...
        return tuples.stream()
                .map(e -> castSqlResult(e, constructor, methodMap))
                .toList();
    }
