...
public class ThirdPartyOAuth2UsernamePasswordAuthenticationProvider extends AbstractOAuth2UsernamePasswordAuthenticationProvider {

    public ThirdPartyOAuth2UsernamePasswordAuthenticationProvider(ApplicationProperties applicationProperties,
    ...
    protected void validateOAuth2Client(AbstractClientUserAuthenticationToken authentication, RegisteredClient registeredClient) {
        if (!this.applicationProperties.getThirdPartyOAuth2ClientInfo().getClientId().equals(registeredClient.getClientId())) {
