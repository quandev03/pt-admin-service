...
public class PartnerOAuth2UsernamePasswordAuthenticationProvider extends AbstractOAuth2UsernamePasswordAuthenticationProvider {

    public PartnerOAuth2UsernamePasswordAuthenticationProvider(ApplicationProperties applicationProperties,
    ...
    protected void validateOAuth2Client(AbstractClientUserAuthenticationToken authentication, RegisteredClient registeredClient) {
        if (!this.applicationProperties.getPartnerWebOAuth2ClientInfo().getClientId().equals(registeredClient.getClientId())) {
